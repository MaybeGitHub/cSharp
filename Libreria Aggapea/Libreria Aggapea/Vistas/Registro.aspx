<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="Libreria_Aggapea.WebForm1" EnableSessionState="True" %>
    ...
    <div>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td class="auto-style1">&nbsp;</td>
                <td>
                    <asp:ImageButton ID="registrar_boton" runat="server" Height="29px" ImageUrl="~/Vistas/Imagenes/registroAgapea_Boton.png" OnClick="registrar_boton_Click" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
